...
class RandomTopologySIS:
    ...
    def create_agents_dict(self):
        ...
        self.agents_dict["Agents"]["Green"]["actions"] = ["Sleep", "GreenPingSweep", "GreenPortScan", "GreenConnection"]
        ...
        self.agents_dict["Agents"]["Green"]["reward_calculator_type"] = "None"
            ...
            # hosts belonging to operational subnet
                ...
                if host.endswith("Op_Database"):
                    self.hosts_dict["Hosts"][host] = {"AWS_Info": [], "image": "OP_Database", 
                                                      ...
                                                      "ConfidentialityValue": "Medium", "AvailabilityValue": "Medium",}
