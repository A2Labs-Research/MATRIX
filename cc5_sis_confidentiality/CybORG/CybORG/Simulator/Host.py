...
class Host(Entity):
    ...
    def __init__(self, system_info: dict, hostname: str = None, users: dict = None,
        ...
        self.events = {'NetworkConnections': [], 'ProcessCreation': [], 'SuspiciousActivity': []}
        self.traffic_blocked = False
        self.tunnel = False
        self.exfiltrate_times = 0
        self.suspicious_network_activity = False
        self.blacklist_ips = []

    def block_traffic(self):
        self.traffic_blocked = True 
        self.tunnel = False
    ...
    def tunnel_established(self):
        self.tunnel = True
        return self.tunnel
    
    def tunnel_destroyed(self):
        self.tunnel = False
        return self.tunnel

    def exfiltrate(self):
        self.exfiltrate_times += 1
        return self.exfiltrate_times
