...
if __name__ == "__main__":
    ...
    # blue_agent = BlueReactBlockAgent
    ...
    cyborg = CybORG(None, 'sim', agents={'Red': red_agent, 'Blue': blue_agent}, random_red_init=random_red_init, random_topologies=random_topology, seed = topology_seed)
