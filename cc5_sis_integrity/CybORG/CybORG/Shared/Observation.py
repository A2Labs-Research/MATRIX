...
class Observation:
    ...
    def add_system_info(self,
        ...
        if defaced_status is None:
            defaced_status = kwargs.get("defaced_status", None)
        if defaced_status is not None:
            sys_info["defaced_status"] = defaced_status
    ...
    def add_defaced_activity(self,
                            hostid: str = None,
                            defaced_status: str = None,
                            host_ip: str = None,
                            green_complainers: list = [],
                            **kwargs):

        self.data['user_complaint'] = [{'defaced_status': defaced_status,
                                        'ip_address': host_ip,
                                        'hostname': hostid,
                                        'green_complainers': green_complainers}]
