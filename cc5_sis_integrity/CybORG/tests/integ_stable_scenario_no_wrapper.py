...
from CybORG.Agents import BlueReactRemoveAgent, BlueReactRestoreAgent, BlueMonitorAgent, BlueReactRemoveRestoreContentAgent, GreenConsumeAgent, RedMeanderAgent_SIS_random, B_lineAgent_SIS_random
...
if __name__ == "__main__":
    ...
    # blue_agent = BlueReactRemoveRestoreContentAgent
    ...
    # 5. Choose scenario:
    # scenario_name = '/Shared/Scenarios/SIS_Integrity_Scenarios/Scenario2_SIS.yaml'
    # scenario_name = '/Shared/Scenarios/SIS_Integrity_Scenarios/Scenario2_SIS_1.yaml'
    # scenario_name = '/Shared/Scenarios/SIS_Integrity_Scenarios/Scenario2_SIS_2.yaml'
    # scenario_name = '/Shared/Scenarios/SIS_Integrity_Scenarios/Scenario2_SIS_3.yaml'
    scenario_name = '/Shared/Scenarios/SIS_Integrity_Scenarios/Scenario2_SIS_4.yaml'
    # scenario_name = '/Shared/Scenarios/SIS_Integrity_Scenarios/Scenario2_SIS_5.yaml'
